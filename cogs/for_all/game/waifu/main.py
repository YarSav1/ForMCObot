...
from config.functional_config import check_channels, check_fields, GENERAL_COLOR, money_emj, failure, FAILURE_COLOR, \
    accept, \
    SUCCESS_COLOR, buy_waifu_and_get_balance, counter_number
