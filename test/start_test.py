...
if request:
    ...
    for DirPath_1, DirName_1, filenames in os.walk("test_cogs"):
    ...
    async def on_ready():
        # if py.is_ready():
        #     print('\033[0mЗапуск кнопок.')
        #     try:
        #         DiscordComponents(py)
        #         print('\033[32mКнопки есть!')
        #     except Exception as error:
        #         print(f'\033[31mКнопки не запущены - {error}\n'
        #               f'Бот остановлен!')
        #         return await py.close()
